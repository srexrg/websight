        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-4">
            <Link href="/">
              <Button 
                variant="ghost" 
                className="text-gray-300 hover:text-white gap-2 font-oswald"
              >
                <ArrowLeft className="h-4 w-4" />
                Back to Home
              </Button>
            </Link>
            <h1 className="text-xl font-semibold text-white font-ja">Documentation</h1>
          </div>
        </div>
      </header>
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h1 className="text-4xl font-bold mb-4 text-white font-oswald">
              WebSight Documentation
            </h1>
            <p className="text-lg text-gray-300 font-jakarta">
            ...
            {guides.map((guide) => (
              <Link key={guide.title} href={guide.href}>
                <div className="p-6 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors bg-black/50 backdrop-blur-sm">
                  ...
                  <h2 className="text-xl font-semibold text-white mb-2 font-oswald">
                    {guide.title}
                  </h2>
