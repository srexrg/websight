...
Use `next/script` with the defer strategy in your root layout. Prefer a component? Install the [JavaScript SDK](/docs/tracking/sdk) and drop `<Analytics site="yourdomain.com" />` into your layout instead.
