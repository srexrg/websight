...
Using a framework or a CMS? See [Install on your platform](/docs/getting-started/install) for ready-made snippets for all nine platforms, including Next.js, WordPress, and Shopify.
